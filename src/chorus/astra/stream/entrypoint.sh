...
: "${ORIGIN_URI:=http://servers:8082/astra}"
...
export STREAM_WEBHOOK_PUBLISH="${ORIGIN_URI}${STREAM_WEBHOOK_PUBLISH_PATH}"
export STREAM_WEBHOOK_UNPUBLISH="${ORIGIN_URI}${STREAM_WEBHOOK_UNPUBLISH_PATH}"
