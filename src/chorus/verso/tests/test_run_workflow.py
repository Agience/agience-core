...
# Import the verso server module by file path so the bare module name
...
_verso_server = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(_verso_server)
_evaluate_condition = _verso_server._evaluate_condition
run_workflow = _verso_server.run_workflow
